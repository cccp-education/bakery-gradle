...
link:README_truth_fr.adoc[Version Française]
...
The latest version of the plugin (0.0.2+) supports the 10 most spoken languages
in the world (source: `10 langues les plus parlés.csv`), covering ~5.4 billion speakers
via Thymeleaf message externalization.
...
| `fr` | French (Français) | 417 million | LTR
...
See the new `README.adoc` for the full i18n configuration reference.

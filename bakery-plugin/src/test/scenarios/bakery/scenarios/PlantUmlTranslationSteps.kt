...
class PlantUmlTranslationSteps {
    ...
    private val labelAwareTranslator: TranslationService =
    ...
    private val failingTranslator: TranslationService =
        object : TranslationService {
            override fun translate(request: TranslationRequest): TranslationResult = TranslationResult.Failure("boom")
        }
    ...
    fun sourceBlockOfLanguageWithContent(
        language: String,
        content: String,
    ) {
    ...
    fun plantumlSourceBlockWithTranslatableLabels(
        label1: String,
        label2: String,
    ) {
        block =
    ...
    fun plantumlSourceBlockWithBorrowedVocabularyAndLabel(
        term1: String,
        term2: String,
        label: String,
    ) {
    ...
    fun plantumlSourceBlockWithBorrowedVocabularyAndOneLabel(
        term: String,
        label: String,
    ) {
        block =
    ...
    fun plantumlSourceBlockWithCodeIdentifierAndLabel(
        identifier: String,
        label: String,
    ) {
        block =
    ...
    fun plantumlAdapterTranslatesBlock(

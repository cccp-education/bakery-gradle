...
class OllamaLlmServiceTest {
    ...
    @Test
    fun `complete delegates prompt to ChatModel and returns response`() =
        runBlocking {
    ...
    @Test
    fun `complete handles multiline prompt correctly`() =
        runBlocking {
    ...
    @Test
    fun `complete preserves empty response from model`() =
        runBlocking {

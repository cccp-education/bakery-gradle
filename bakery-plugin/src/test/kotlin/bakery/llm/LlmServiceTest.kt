...
class LlmServiceTest {
    @Test
    fun `complete returns generated text for a prompt`() =
        runBlocking {
    ...
    @Test
    fun `complete records prompts received for audit trail`() =
        runBlocking {
    ...
    @Test
    fun `complete works with empty prompt and empty response`() =
        runBlocking {

...
class ResolvedConfigsTest {
    ...
    private fun createExtension(): BakeryExtension = project.extensions.create("bakery_test", BakeryExtension::class.java)
    ...
    inner class ConfigResolutionErrorTest {
        ...
        fun `MissingRequiredField holds domain and field`() {
            val error =
                ConfigResolutionError.MissingRequiredField(
                    domain = "firebase",
                    field = "apiKey",
        ...
        fun `InvalidValue holds domain field and value`() {
            val error =
                ConfigResolutionError.InvalidValue(
                    domain = "layout",
                    field = "layoutType",
                    value = "INVALID",

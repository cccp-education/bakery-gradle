...
class PostMigrationGoldenMasterTest {
    ...
    @Test
    fun `magic-stick migration matches golden master snapshot`(
    ...
    @Test
    fun `cccp-education migration matches golden master snapshot`(
        @TempDir tempDir: File,
    ) {
    ...
    @Test
    fun `cheroliv-com migration matches golden master snapshot`(
        @TempDir tempDir: File,
    ) {
     ...
     */
    private fun assertMigrationMatchesGoldenMaster(
        siteId: String,
        tempDir: File,
    ) {

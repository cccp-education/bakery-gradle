...
class I18nTemplateMigrationTest {
    ...
    private val siteBasicTemplates =
        listOf(
        ...
        fun `site templates use message keys for i18n`() {
            val expectedKeys =
                mapOf(
                    ...
                    "site/templates/blog.thyme" to
                        listOf("nav.blog", "nav.archives", "action.search", "nav.memo", "action.read.more", "action.search.article", "action.scroll.top"),
                    "site/templates/contact.thyme" to
                        listOf(
                            "nav.contact",
                            "contact.subtitle",
                    ...
                    "site/templates/menu.thyme" to
                        listOf(
                            "image.alt.logo",
                            "site.title",
                            "a11y.toggle.navigation",
                            "nav.home",
                            "nav.blog",
                            "nav.contact",
                            "a11y.theme.switcher",
                    ...
                    "site/templates/comments.thyme" to
                        listOf(
                            "comments.heading",
                            "comments.loading",
                            "comments.form.label",
                    ...
                    "site/templates/newsletter-form.thyme" to
                        listOf("newsletter.heading", "newsletter.description", "newsletter.email.placeholder", "newsletter.subscribe.button"),
                    ...
                    "site/templates/hero_section.thyme" to
                        listOf(
                            "hero.brand",
                            "hero.brand.sub",
                            "hero.description",

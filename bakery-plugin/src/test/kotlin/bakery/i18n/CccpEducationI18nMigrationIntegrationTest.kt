...
class CccpEducationI18nMigrationIntegrationTest {
    ...
    private fun loadFixture(): File {
        val resource =
            this::class.java.classLoader.getResource("i18n-fixtures/cccp-education/jbake")
    ...
    private fun loadTranslationsFromResources(): Map<String, String> {
        val url =
            this::class.java.classLoader.getResource("i18n-fixtures/cccp-education/translations_en.properties")
    ...
    @Test
    fun `dry-run on cccp-education fixture scans templates without modifying them`(
    ...
    @Test
    fun `proper names and project identifiers are not extracted`(
        @TempDir tempDir: File,
    ) {
        val siteDir = copyFixtureToTemp(tempDir)

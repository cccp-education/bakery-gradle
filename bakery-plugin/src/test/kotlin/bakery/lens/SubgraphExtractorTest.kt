...
class SubgraphExtractorTest {
    ...
    inner class FileLoading {
        ...
        @Test
        @DisplayName("loadGraph tolère un graph.json portant des champs inconnus (GF-SCHEMA-5)")
        ...
        @Test
        @DisplayName("loadGraph lit un graph.json legacy dépourvu de schemaVersion")

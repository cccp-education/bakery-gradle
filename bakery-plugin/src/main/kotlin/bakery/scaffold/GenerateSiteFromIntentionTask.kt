...
abstract class GenerateSiteFromIntentionTask : DefaultTask() {
    ...
    fun executeGenerate() {
        ...
        logger.lifecycle(
            "[generateSiteFromIntention] Type : {}, Lang : {}, Projet : {}",
            resolvedIntention.siteType,
            resolvedIntention.lang,
            resolvedIntention.projectName,
        )
        ...
        logger.lifecycle(
            "[generateSiteFromIntention] Metadonnees : titre={}, tags={}",
            output.metadata.title,
            output.metadata.tags.joinToString(", "),
        )

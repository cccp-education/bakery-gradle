...
dependencies {
    add(functionalTest.implementationConfigurationName, platform("education.cccp:workspace-bom:0.0.42"))
...
dependencies {
    add(e2eTest.implementationConfigurationName, platform("education.cccp:workspace-bom:0.0.42"))

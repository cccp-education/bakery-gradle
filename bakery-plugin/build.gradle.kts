...
dependencies {
    ...
    implementation(platform("education.cccp:workspace-bom:0.0.37"))
...
dependencies {
    add(functionalTest.implementationConfigurationName, platform("education.cccp:workspace-bom:0.0.37"))
...
dependencies {
    add(e2eTest.implementationConfigurationName, platform("education.cccp:workspace-bom:0.0.37"))
